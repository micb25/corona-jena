...
if __name__ == "__main__":
    ...
    try:
        ...
        if ( sum_cases >= 0 ):
            svgdata = svgdata.replace("%LABEL_SUM%", "%i stationäre Fälle" % (sum_cases))
        else:
        ...
        os.system( "convert {} gradient_o.png -gravity northwest -geometry +552+95 -composite -quality 80 {}".format(PNGFILET, JPGFILE) )
