...
# y-axis setup
set ylabel 'belegte Intensivbetten mit COVID-19 in Deutschland'
...
plot  \
  ...
  "<awk -F, '{if ( NR > 1 ) print $1,$5}' ../data/divi_db_th/divi_data_germany.csv" using 1:2 with lines ls 18 title "COVID-19-Fälle auf Intensivstation", \
  \
