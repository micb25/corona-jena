...
# get maximum value
stats "<awk -F, 'BEGIN{d=0;}{if ((NR>1)&&($1>1584230400)) {print int($1/86400)*86400,$3-d;d=$3;}}' ../data/cases_th_sums.csv" using 2 name "A" nooutput
...
set label 1 at graph 0.98, 0.95 "{/Linux-Libertine-O-Bold Genesungen pro Tag in Thüringen}" right textcolor ls 0
