...
plot  \
  ...
  "<awk '!_[$4]++' ../data/cases_jena.dat | tail -n 1" using 1:4:($4) with labels point pt 7 center offset char -0.3, 0.8 tc ls 5 notitle, \
  "<awk '!_[$3]++' ../data/cases_jena.dat | tail -n 1" using 1:3:($3) with labels point pt 7 center offset char -0.3, 0.8 tc ls 4 notitle, \
  "<awk '!_[$2]++' ../data/cases_jena.dat | tail -n 1" using 1:2:($2) with labels point pt 7 center offset char -0.3, 0.8 tc ls 1 notitle, \
  "<awk '!_[$4]++' ../data/cases_jena.dat" using 1:4 with linespoints ls 5 title "Verstorbene", \
  "<awk '!_[$3]++' ../data/cases_jena.dat" using 1:3 with linespoints ls 4 title "Genesene", \
