...
set label 2 at graph 0.99, 0.93 "{/*0.75 Quelle: RKI}" right textcolor ls 0

set offsets 0.00, 0.00, graph 0.15, 0.00

plot  \
  "<awk -F, '{if ($2==\"TH\") print $1,$3-$4-$5}' ../data/rki_th_by_date/cases_by_day_and_region.csv" using 1:(filter_neg($2)) with lines lt 1 lw 3.0 lc '#007af2' title "aktive Fälle"
