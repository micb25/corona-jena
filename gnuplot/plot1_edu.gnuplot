...
set style line 81 lc rgb '#fec615' lt 1 lw 1 pt 9 ps 2.00 dt "."
set style line 82 lc rgb '#e50000' lt 1 lw 1 pt 9 ps 2.00 dt "."
set style line 83 lc rgb '#fec615' lt 1 lw 1 pt 7 ps 2.00 dt "."
set style line 84 lc rgb '#e50000' lt 1 lw 1 pt 7 ps 2.00 dt "."
...
set offsets graph 0.02, graph 0.15, graph 0.40, 0.00
