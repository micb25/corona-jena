...
# data
plot  \
  "<awk -F, 'BEGIN{d=0;}{if (NR>1) {if ($1>=1584352800) print int($1/86400)*86400,$4-d;d=$4;}}' ../data/cases_th_sums.csv" using 1:2 with boxes lt rgb "#52555e" notitle, \
