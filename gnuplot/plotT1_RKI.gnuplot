...
plot  \
  ...
  "<awk -F, '{print $1, $2, $3}' ../data/cases_thuringia_rki.csv | awk '{if ($2 >= 0) print $0}' | tail -n 1" using 1:3:($3) with labels point pt 7 center offset char -0.3, 0.8 tc ls 5 notitle, \
