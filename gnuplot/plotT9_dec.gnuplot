...
# data
plot  \
 "<awk -F, 'BEGIN{d=0;for(i=0;i<7;i++){a[i]=0}}{if (NR>1) {if ($1>=1584352800) {for(i=0; i<6; i++){a[i]=a[i+1]};a[6]=$4-d;b=0;for(i=0;i<7; i++){b=b+a[i]};print int($1/86400)*86400,b/7;d=$4;}}}' ../data/cases_th_sums.csv" using ($1-730*86400):2 with lines lw 2 lt rgb "#7d7f7c" title " 2022/2023", \
