...
# get sum beds
stats "<awk -F, '{print $2}' ../data/divi_db_th/divi_data_th.csv | tail -n 1" u 1 prefix "A" nooutput

# get occupied beds
stats "<awk -F, '{print $3}' ../data/divi_db_th/divi_data_th.csv | tail -n 1" u 1 prefix "B" nooutput

# get free beds
stats "<awk -F, '{print $4}' ../data/divi_db_th/divi_data_th.csv | tail -n 1" u 1 prefix "C" nooutput

# get number of covid 19 patients
stats "<awk -F, '{print $5}' ../data/divi_db_th/divi_data_th.csv | tail -n 1" u 1 prefix "E" nooutput

# get number of covid 19 patients with ventilation treatment
stats "<awk -F, '{print $6}' ../data/divi_db_th/divi_data_th.csv | tail -n 1" u 1 prefix "F" nooutput
