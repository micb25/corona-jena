...
# get sum of infected
stats "<awk -F, '{print $1,$2,$3,$4,$5}' ../data/cases_grz.csv" u 2 prefix "A" nooutput

# get maximum number of recovered
stats "<awk -F, '{print $1,$2,$3,$4,$5}' ../data/cases_grz.csv" u 3 prefix "B" nooutput

# get maximum number of deceased
stats "<awk -F, '{print $1,$2,$3,$4,$5}' ../data/cases_grz.csv" u 4 prefix "C" nooutput

# get number of hospitalized
stats "<awk -F, '{print $1,$2,$3,$4,$5,$6}' ../data/cases_grz.csv | tail -n 1" u 5 prefix "E" nooutput

# get number of severe
stats "<awk -F, '{print $1,$2,$3,$4,$5,$6}' ../data/cases_grz.csv | tail -n 1" u 6 prefix "F" nooutput
...
plot \
     ...
     \
     "<echo 0" u (xpos):(ypos(0.25)):(sprintf("%i bestätigte Fälle im LK Greiz", A_max)) w labels left offset 2.5, 0, \
     "<echo 0" u (xpos):(ypos(1.75)) w p pt 5 ps 4 lc rgb "#007af2", \
     "<echo 0" u (xpos):(ypos(1.75)):(sprintf(A_max - B_max - C_max != 1 ? "%i aktive Fälle (%.1f%%)" : "%i aktiver Fall (%.1f%%)", A_max - B_max - C_max, 100*(A_max-B_max-C_max)/A_max)) w labels left offset 2.5, 0, \
     ...
     "<echo 0" u (xpos):(ypos(7.85)):("Quelle: Landkreis Greiz") w labels font ", 12" left offset 2.5, 0
