...
# stats for x
stats "<awk '!_[$2]++' ./cases_thuringia_rki.dat" using 1 nooutput
...
b = 0.30
f(x) = a * exp( b * x )
fit f(x) "<awk '!_[$2]++' ./cases_thuringia_rki.dat" using (($1 - xmin_o) / 86400):2 via a, b
...
# R2
stats "<awk '!_[$2]++' ./cases_thuringia_rki.dat" using (f(($1 - xmin_o) / 86400)):2 name "A" nooutput
