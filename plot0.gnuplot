...
plot \
     ...
     "<cat ./cases_jena.dat | tail -n 1" u (xpos):(ypos(2)):(sprintf("%i aktive Fälle* (%.1f%%)", $2 - B_max - C_max, 100*($2-B_max-C_max)/A_max)) w labels left offset 2.5, 0, \
     ...
     "<cat ./cases_jena.dat | tail -n 1" u (xpos):(ypos(3)):(sprintf("%i Genesene* (%.1f%%)", B_max, 100*B_max/A_max)) w labels left offset 2.5, 0, \
     ...
     "<cat ./cases_jena.dat | tail -n 1" u (xpos):(ypos(4)):(sprintf("%i Verstorbene(r) (%.1f%%)", C_max, 100*C_max/A_max)) w labels left offset 2.5, 0, \
